...
export const ventures: Venture[] = [
  ...
  },
  {
    ...
    what:
      'Think App Store, but for Claude\'s brain. Every listing is a pre-built professional configuration for a specific job — HR, recruiting, real estate, finance, engineering, and more. Currently live with ~100 listings across four categories.',
    accent: '#3B82F6',
    status: 'live',
